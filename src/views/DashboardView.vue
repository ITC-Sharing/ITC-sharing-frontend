    ...
    <div class="mx-auto max-w-7xl px-6 py-8 flex flex-col gap-8">
      ...
      <div class="flex items-start justify-between flex-wrap gap-4">
        ...
        <button
          ...
          class="flex items-center gap-2 bg-[#0057BD] hover:bg-[#0948A0] active:scale-95 text-white text-sm font-semibold px-5 py-3 rounded-xl transition-all shadow-sm"
        >
          <svg
