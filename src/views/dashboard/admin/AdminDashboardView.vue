...
// ── Stats ─────────────────────────────────────────────────────────────────────
const stats = ref({ totalUsers: 0, totalDocuments: 0 })
            ...
            >
              ...
              >
                ...
                <p class="col-span-1 text-xs text-gray-500">
                  {{ formatSize(totalSize(doc.documents)) }}
                </p>
              ...
              <!-- ── Expanded file list ── -->
              <div
                v-if="expandedUploadId === doc.id"
                class="bg-gray-50/70 border-t border-gray-100 px-8 py-3"
              >
