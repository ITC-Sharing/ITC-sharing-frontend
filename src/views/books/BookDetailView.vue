    ...
    <div class="mx-auto w-full max-w-7xl px-6">
      ...
      <div v-else-if="book" class="flex flex-col md:flex-row gap-8 overflow-hidden">
        ...
        <div class="w-full md:w-[55%] shrink-0">
          <div
            class="flex h-full items-center justify-center rounded-2xl bg-gray-50 border border-gray-200 p-4"
            style="min-height: 400px; max-height: 560px"
          >
            <img
              :src="book.cover_image_url || noImage"
              :alt="book.title"
              class="max-h-full max-w-full object-contain rounded-lg cursor-pointer"
        ...
        <div class="flex flex-1 flex-col gap-4 px-6 py-6 md:py-0">
          ...
          <!-- Already requested -->
          <div
            v-else-if="myRequest?.status === 'pending'"
            class="mt-2 rounded-xl border border-yellow-200 bg-yellow-50 p-4"
          >
    ...
    >
      <div class="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <label class="mt-4 block text-xs font-medium text-gray-600"
          >Your telegram link or username <span class="text-red-500">*</span></label
        >
        <input
